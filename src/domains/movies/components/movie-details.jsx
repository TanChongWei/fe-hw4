...
export const MovieDetails = ({ movieId }) => {
    ...
    const movieData = useMovieComments(movieId);
    const movieComments = movieData.data
    const loadData = movieData.loadData
    ...
    const addComment = () => {
        if (!comment) {
            window.alert('comment field must not be empty!')
